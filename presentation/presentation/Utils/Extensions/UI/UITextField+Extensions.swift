...
extension UITextField {
    convenience init(placeholder: String = "", backgroundColor: UIColor? = .clear, alignment: NSTextAlignment = .left, textColor: UIColor, placeholderColor: UIColor? = nil, font: UIFont, adjustsFontSize: Bool) {
        self.init()
